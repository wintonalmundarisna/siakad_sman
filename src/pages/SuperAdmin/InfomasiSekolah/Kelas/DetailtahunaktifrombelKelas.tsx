      ...
      <main className={`w-full min-h-screen bg-background transition-all duration-300 ${isCollapsed ? "md:ml-16" : "md:ml-[300px]"}`}>
        ...
        <div className="mx-auto p-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            <Button variant="outline" size="sm" onClick={() => navigate(`/superadmin/informasi-sekolah/kelas/${data?.kelas?.kelas_id}`)}>
              <ArrowLeft size={16} />
            </Button>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded shadow p-5">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-4">
                  ...
                  <Link to={`/superadmin/informasi-sekolah/wali-rombel/create?rombel_id=${data.rombel_id}&nama_rombel=${encodeURIComponent(data.nama_rombel)}`}>
                ...
                {periode?.wali ? (
                  <div className="flex items-center justify-between bg-gray-50 p-3 rounded border">
                    ...
                    <div className="flex gap-1">
                      <Link
                        to={
                          `/superadmin/informasi-sekolah/wali-rombel/edit/${periode.wali.wali_rombel_id}` +
              ...
              <div className="bg-white rounded shadow p-5">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-4">
                  ...
                  <Link to={`/superadmin/informasi-sekolah/siswa-rombel/create?rombel_id=${data.rombel_id}&nama_rombel=${encodeURIComponent(data.nama_rombel)}`}>
                    <Button className="bg-primary" size="sm">
                          ...
                          <TableRow key={siswa.siswa_rombel_id ?? idx} className="hover:bg-indigo-50 even:bg-gray-50 border-b">
                            ...
                            <TableCell>
                              <div className="flex gap-1 justify-center">
                                <Link
                                  to={
                                    `/superadmin/informasi-sekolah/siswa-rombel/edit/${siswa.siswa_rombel_id}` +
                                    `?rombel_id=${data.rombel_id}` +
                                    `&nama_rombel=${encodeURIComponent(data.nama_rombel)}` +
              ...
              <div className="bg-white rounded shadow p-5">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-4">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    <Link to={`/superadmin/informasi-sekolah/jadwal-pelajaran-guru/create?rombel_id=${data.rombel_id}&nama_rombel=${encodeURIComponent(data.nama_rombel)}`}>
                      <Button className="bg-primary" size="sm">
                                  ...
                                  <TableRow key={j.jadwal_pelajaran_id} className="hover:bg-indigo-50 border-b">
                                    ...
                                    <TableCell>
                                      <div className="flex gap-1 justify-center">
                                        <Link
                                          to={
                                            `/superadmin/informasi-sekolah/jadwal-pelajaran-guru/edit/${j.jadwal_pelajaran_id}` +
                                            `?rombel_id=${data.rombel_id}` +
                                            `&nama_rombel=${encodeURIComponent(data.nama_rombel)}` +
