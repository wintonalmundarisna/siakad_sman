 ...
 *   /superadmin/informasi-akademik/rombel/create?kelas_id=X&nama_kelas=Y
 *
 * Link ke EditRombel:
 *   /superadmin/informasi-akademik/rombel/edit/:rombelId
...
const DetailKelas = () => {
  ...
  const buildEditRombelUrl = (rombel: RombelItem) => {
    ...
    return `/superadmin/informasi-akademik/rombel/edit/${rombel.rombel_id}?${params.toString()}`;
  };
      ...
      <main className={`w-full min-h-screen bg-background transition-all duration-300 ${isCollapsed ? "md:ml-16" : "md:ml-[300px]"}`}>
        ...
        <div className="mx-auto p-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-6">
            <Button variant="outline" size="sm" onClick={() => navigate("/superadmin/informasi-akademik/kelas")}>
              <ArrowLeft size={16} />
              Kembali
            </Button>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded shadow p-5">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-4">
                  ...
                  <Link to={`/superadmin/informasi-akademik/rombel/create?kelas_id=${data.kelas_id}&nama_kelas=${encodeURIComponent(data.nama_kelas)}`}>
                          ...
                          <TableRow key={rombel.rombel_id} className="hover:bg-indigo-50 even:bg-gray-50 border-b border-gray-100">
                            ...
                            <TableCell>
                              <div className="flex gap-1 justify-center">
                                ...
                                <Link to={`/superadmin/informasi-akademik/rombel/aktif/${rombel.rombel_id}`}>
