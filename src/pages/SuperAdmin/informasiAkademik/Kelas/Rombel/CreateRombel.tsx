  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (res.data.status === "success") {
        ...
        navigate(`/superadmin/informasi-akademik/kelas/${kelasId}`);
      }
    } catch (err: any) {
      ...
      <main className={`w-full min-h-screen bg-background transition-all duration-300 ${isCollapsed ? "md:ml-16" : "md:ml-[300px]"}`}>
        ...
        <div className="mx-auto p-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            <Button variant="outline" size="sm" onClick={() => navigate(`/superadmin/informasi-akademik/kelas/${kelasId}`)}>
              <ArrowLeft size={16} />
              Kembali
            </Button>
            ...
            {loadingSelect ? (
              ...
              <form className="space-y-5 max-w-lg w-full" onSubmit={handleSubmit}>
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <Button type="button" className="bg-muted-foreground flex items-center gap-2 hover:bg-muted-foreground/90" onClick={() => navigate(`/superadmin/informasi-akademik/kelas/${kelasId}`)}>
